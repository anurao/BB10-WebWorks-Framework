...
var onRotate2 = function (width, height, angle) {
    debugger;
    var app = window.qnx.webplatform.getApplication();
    pendingViewportChanges = 0;
...
qnx.webplatform.getController().addEventListener("invocation.cardResize", onRotate2);
...
var app = window.qnx.webplatform.getApplication();
app.addEventListener('application.propertyViewportEvent', function () {
