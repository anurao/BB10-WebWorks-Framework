...
webview =
    ...
    create: function (ready) {
        _webviewObj = window.qnx.webplatform.createWebView({processType: "InProcess", defaultHandlers: ['onChooseFile']}, function () {
    ...
    setPatternMatching: function (enabled) {
        _webviewObj.setPatternMatching(enabled);
    },
