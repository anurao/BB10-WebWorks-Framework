...
function viewImage() {
    ...
    if (_utils.startsWith(_currentContext.src, "local:///")) {
        ...
        _tempStorage.saveImage(_currentContext.src, function (filePath) {
            debugger;
            invokeFile('file:/' + filePath, transferMode, function (params) {
                //Let's register here for the onCardClosed and delete the file
                console.log("Invoked and registering for onCardClosed");
            });
